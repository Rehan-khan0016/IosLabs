...
let laptop1 = Laptop(screenSize: 15, repairCount: 1 ,  yearPurchased: 2020)
let laptop2 = Laptop(screenSize: 10, repairCount: 0, yearPurchased: 2024)
print(laptop1)
print(laptop2)
/*:
...
struct Height{
    ...
    var heighInCentimeters: Double
    init(inches: Double){
        self.heightInInches = inches
        self.heighInCentimeters = inches * 2.54
    }
    init(cm: Double){
        heightInInches = cm / 2.54
        heighInCentimeters = cm
    }
}
...
print("height in centimeters: \(someonesHeight.heighInCentimeters)")
...
var myHeight = Height(cm: 155)
print("height in inches: \(myHeight.heightInInches)")
print("height in centimeters: \(myHeight.heighInCentimeters)")
