...
var Udita = User(name: "Udita", age: 19, height: 1.5, weight: 55, activityLevel: 7)
print("Hello, my name is \(Udita.name) and I am \(Udita.age) years old. My height is \(Udita.height) and my weight is \(Udita.weight) with activity level \(Udita.activityLevel).")
